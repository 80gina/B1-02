**B1-2 스토리보드(기획) 문서_‘할머니 손맛 전라도’ 레시피북(recipe) 소개 영상**
==========

> 본 보고서 할머니 손맛 전라도 레시피북(recipe) 브랜드 광고 영상 제작 프로젝트를 위한 스토리보드(기획) 문서입니다. 총 10초 분량의 영상을 3개 씬으로 구성했습니다.
> (계획)
> - 씬 1은 텅 빈 냉장고로 시청자 공감을 유발하고,
> - 씬 2는 레시피(recipe)북 표지를 등장시켜 제품을 각인시킵니다.
> - 씬 3은 레시피(recipe)북 내지 클로즈업으로 신뢰감을 확보하고,
> - 씬 4는 브랜드 슬로건과 CTA로 마무리합니다.
> 
> (변경)
> - 씬 1는 레시피(recipe)북 표지를 등장시켜 제품을 각인시킵니다.
> - 씬 2은 레시피(recipe) 내지 클로즈업으로 신뢰감을 확보하고,
> - 씬 3는 브랜드 슬로건과 CTA로 마무리합니다.
> 

각 씬마다 전라도 사투리를 활용한 할머니 유머 포인트를 삽입해 친근함을 극대화했습니다. 제작 도구는 Gemie, Flow, Vrew, Suno AI를 조합해 사용하며,  크레딧은 씬 1·3에만 집중해 최소화합니다. 화풍 일관성은 씬 1 기준 이미지를 --sref로 고정해 유지합니다. 감정 아크는 공감→웃음→신뢰→구매욕구 4단계로 설계되었습니다.
...
→ 레퍼런스 이미지의 "캔디드 라이프스타일 푸드북 리뷰" 톤을 할머니 레시피북 소개 영상에 그대로 이식
...
오디오         ElevenLabs 목적: 씬 3 할머니 내레이션 생성 자신만만 + 살짝 투덜대는 톤 
